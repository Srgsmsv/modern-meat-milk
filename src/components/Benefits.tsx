...
const benefitsData = [
  {
    ...
    title: "Привлекательность для потребителей",
    description: "Улучшите вкус, текстуру и внешний вид ваших продуктов, чтобы создать превосходный опыт для потребителей и повысить привлекательность продукта."
  },
  {
    icon: (
    ...
    description: "Наши системы сохранения значительно продлевают срок хранения продукта, сохраняя при этом вкус и качество на протяжении всего цикла распространения."
  },
  {
    icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-brand-red">
    ...
    title: "Улучшенная переработка",
    description: "Оптимизируйте эффективность производства, снижайте затраты на производство и повышайте выход с помощью наших специализированных добавок для переработки."
  },
  {
    icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-brand-gold">
    ...
    description: "Обеспечьте безопасность продукта и соответствие нормативным требованиям с помощью наших научно обоснованных систем сохранения и стабильности."
  },
  {
    icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-brand-red">
    ...
    title: "Чистые метки",
    description: "Удовлетворите потребности потребителей в чистых этикетках с помощью нашего ассортимента натуральных и удобных для потребителей решений."
  },
  {
    icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-brand-gold">
    ...
    title: "Функциональные преимущества",
    description: "Добавьте питательную ценность с помощью наших систем обогащения или создайте продукты с конкретными полезными свойствами, чтобы привлечь потребителей, заботящихся о здоровье."
  }
];
...
const Benefits = () => {
  ...
  return (
      <section id="Преимущества" className="py-20 bg-white relative overflow-hidden" ref={ref}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h2 className="section-title mx-auto">Почему стоит выбрать наши добавки</h2>
            <p className="section-subtitle">
              Наши специализированные формулы предлагают ощутимые преимущества на всей цепочке производства
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="max-w-2xl">
                <h3 className="text-2xl md:text-3xl font-bold mb-4">Готовы улучшить ваши продукты?</h3>
                <p className="text-gray-600">
                  Наша экспертная команда готова проанализировать ваши конкретные потребности и порекомендовать идеальные добавки для ваших продуктов.
                </p>
              </div>
