...
const AboutUs = () => {
  ...
  return (
      <section id="О нас" className="py-20 bg-white relative overflow-hidden" ref={ref}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="section-subtitle">
              Поддерживаем современные стандарты в технологии разработки пищевых добавок
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div
                ...
                className="space-y-6"
            >
              <h3 className="text-2xl font-bold">Традиции совершенства и инноваций</h3>
              <p className="text-gray-600">
                С момента основания мы увлечены разработкой передовых решений для мясной и молочной промышленности. Наша команда опытных пищевых ученых и инженеров работает неустанно, создавая добавки, которые улучшают качество, увеличивают срок хранения и улучшают питательные характеристики.
              </p>
              <p className="text-gray-600">
                Мы гордимся нашей приверженностью устойчивому развитию, качеству и удовлетворенности клиентов. Каждый продукт, который мы разрабатываем, проходит строгие испытания, чтобы гарантировать соответствие самым высоким стандартам безопасности и эффективности.
              </p>
              ...
              <div className="pt-4 grid grid-cols-2 gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-gray-500">Продуктов разработано</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-3xl font-bold text-brand-red">50+</span>
                  <span className="text-gray-500">Успешных проектов</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-3xl font-bold text-brand-red">98%</span>
                  <span className="text-gray-500">Удовлетворенность клиентов</span>
                </div>
              </div>
            </motion.div>
                ...
                <div className="relative bg-white shadow-xl rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
                    <div className="p-6 text-white">
                      <h4 className="text-xl font-bold mb-2">Современная исследовательская лаборатория</h4>
                      <p className="text-sm">Наша команда работает с передовыми технологиями для разработки следующего поколения пищевых добавок.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-4">
                ...
                <p className="text-gray-600 text-sm">Все наши продукты проходят строгие испытания на качество, чтобы гарантировать консистентность и эффективность.</p>
              </div>
              ...
              <div className="text-center p-4">
                ...
                <h4 className="text-xl font-bold mb-2">Ориентированность на инновации</h4>
                <p className="text-gray-600 text-sm">Мы постоянно проводим исследования и разрабатываем новые решения для удовлетворения изменяющихся потребностей отрасли.</p>
              </div>
              ...
              <div className="text-center p-4">
                ...
                <h4 className="text-xl font-bold mb-2">Поддержка клиентов</h4>
                <p className="text-gray-600 text-sm">Наша экспертная команда предоставляет персонализированную помощь и техническую поддержку на каждом этапе.</p>
              </div>
            </div>
          </motion.div>
        </div>
